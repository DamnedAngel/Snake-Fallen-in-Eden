...
1. Ajustar parâmetros em ApplicationSettings.txt. Resultado em: XXXXX
2. Configurar nome da aplicação em TargetConfig_Debug.txt e TargetConfig_Release.txt. Resultado em: XXXXX
